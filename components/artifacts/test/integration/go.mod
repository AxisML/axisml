...
// The Dockerfile builds from components/artifacts/ and a `../../../`
// replace would fall outside that build context.
module github.com/axisml/axisml/components/artifacts/test/integration

go 1.26.0

require (
	github.com/axisml/axisml/components/artifacts v0.0.0-00010101000000-000000000000
...
replace (
	github.com/axisml/axisml/components/artifacts => ../..
