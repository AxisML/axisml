-- AxisML Artifacts initial schema. See docs/system_design/artifacts.md.
--
-- Post-redesign: ArtifactRepo is gone. Artifacts are addressed by
-- (namespace, kind, name, version) directly. Namespace is a bare string
-- partition key — Artifacts performs no existence check on it.
...
-- Speeds up the GC scan for stale Uploading rows.
