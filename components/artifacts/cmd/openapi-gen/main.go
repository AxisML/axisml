...
// to docs/openapi/artifacts.yaml at the repo root.
//
...
//
//	go run ./cmd/openapi-gen -o ../../docs/openapi/artifacts.yaml
package main
...
import (
	...
	"github.com/axisml/axisml/components/artifacts/internal/artifact"
...
func main() {
	out := flag.String("o", "../../docs/openapi/artifacts.yaml", "output path")
