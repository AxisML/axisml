...
--
-- Post-redesign: tenant + quota tables are gone — those concerns moved to
-- cluster-manager + tenant-operator. Job/Service rows partition on a bare
-- `namespace` string supplied by the caller.
