...
// WorkspacePersistentVolume describes the /workspace PVC.
type WorkspacePersistentVolume struct {
...
type Workspace struct {
	...
	PersistentVolume  WorkspacePersistentVolume `json:"persistentVolume,omitempty"`
	PVCName           string                    `json:"pvcName,omitempty"`
	PVCSize           string                    `json:"pvcSize,omitempty"`
	PVCUsed           string                    `json:"pvcUsed,omitempty"`
...
// WorkspaceCreateRequest is the body of POST /workspaces.
