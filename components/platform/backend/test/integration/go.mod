module github.com/axisml/axisml/components/platform/backend/test/integration

go 1.26.0

require (
	github.com/axisml/axisml/components/platform/backend v0.0.0
...
replace github.com/axisml/axisml/components/platform/backend => ../..
