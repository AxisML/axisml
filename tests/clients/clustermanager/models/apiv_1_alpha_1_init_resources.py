...
if TYPE_CHECKING:
    from ..models.apiv_1_alpha_1_config_map_spec import Apiv1Alpha1ConfigMapSpec
    from ..models.apiv_1_alpha_1_image_pull_secret_spec import (
        Apiv1Alpha1ImagePullSecretSpec,
    )
    from ..models.apiv_1_alpha_1_secret_spec import Apiv1Alpha1SecretSpec
    from ..models.apiv_1_alpha_1_service_account_spec import (
        Apiv1Alpha1ServiceAccountSpec,
    )


T = TypeVar("T", bound="Apiv1Alpha1InitResources")


@_attrs_define
class Apiv1Alpha1InitResources:
    """
    Attributes:
        config_maps (list[Apiv1Alpha1ConfigMapSpec] | Unset):
        image_pull_secrets (list[Apiv1Alpha1ImagePullSecretSpec] | Unset):
        secrets (list[Apiv1Alpha1SecretSpec] | Unset):
        service_accounts (list[Apiv1Alpha1ServiceAccountSpec] | Unset):
    """

    config_maps: list[Apiv1Alpha1ConfigMapSpec] | Unset = UNSET
    image_pull_secrets: list[Apiv1Alpha1ImagePullSecretSpec] | Unset = UNSET
    secrets: list[Apiv1Alpha1SecretSpec] | Unset = UNSET
    service_accounts: list[Apiv1Alpha1ServiceAccountSpec] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _config_maps is not UNSET:
            ...
            for config_maps_item_data in _config_maps:
                config_maps_item = Apiv1Alpha1ConfigMapSpec.from_dict(
        ...
        if _image_pull_secrets is not UNSET:
            ...
            for image_pull_secrets_item_data in _image_pull_secrets:
                image_pull_secrets_item = Apiv1Alpha1ImagePullSecretSpec.from_dict(
        ...
        if _secrets is not UNSET:
            ...
            for secrets_item_data in _secrets:
                secrets_item = Apiv1Alpha1SecretSpec.from_dict(secrets_item_data)
        ...
        if _service_accounts is not UNSET:
            ...
            for service_accounts_item_data in _service_accounts:
                service_accounts_item = Apiv1Alpha1ServiceAccountSpec.from_dict(
                    service_accounts_item_data
                )

                service_accounts.append(service_accounts_item)

        apiv_1_alpha_1_init_resources = cls(
        ...
        apiv_1_alpha_1_init_resources.additional_properties = d
        return apiv_1_alpha_1_init_resources
