...
T = TypeVar("T", bound="Apiv1Alpha1SecretSpec")


@_attrs_define
class Apiv1Alpha1SecretSpec:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        apiv_1_alpha_1_secret_spec = cls(
            name=name,
            source_secret_ref=source_secret_ref,
            type_=type_,
        )

        apiv_1_alpha_1_secret_spec.additional_properties = d
        return apiv_1_alpha_1_secret_spec
