...
if TYPE_CHECKING:
    ...
    from ..models.resource_pool_capacity import ResourcePoolCapacity
...
class ResourcePool:
    """
    Example:
        {'annotations': {'tenant.axisml.io/managed-by': 'platform'}, 'capacity': {'cpu': '64', 'memory': '512Gi',
            'nvidia.com/gpu': '8'}, 'createdAt': '2026-06-20T08:00:00Z', 'description': 'A100 GPU resource pool.', 'labels':
            {'tier': 'gpu'}, 'name': 'gpu-a100', 'nodeSelector': {'axisml.io/gpu': 'a100'}, 'resourceVersion': '184729',
            'units': [{'annotations': {'tenant.axisml.io/managed-by': 'platform'}, 'description': '2× A100 GPU compute
    ...
    Attributes:
        ...
        capacity (ResourcePoolCapacity | Unset): Optional pool capacity override. When omitted, capacity is derived from
            matching runtime nodes.
    ...
    capacity: ResourcePoolCapacity | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        capacity: ResourcePoolCapacity | Unset
        if isinstance(_capacity, Unset):
            capacity = UNSET
        else:
            capacity = ResourcePoolCapacity.from_dict(_capacity)
