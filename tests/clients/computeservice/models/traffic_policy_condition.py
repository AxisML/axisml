...
T = TypeVar("T", bound="TrafficPolicyCondition")


@_attrs_define
class TrafficPolicyCondition:
    """
    Attributes:
        status (str): Condition status (True, False, Unknown).
        type_ (str): Condition type (e.g. Ready, Programmed).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traffic_policy_condition.additional_properties = d
        return traffic_policy_condition
