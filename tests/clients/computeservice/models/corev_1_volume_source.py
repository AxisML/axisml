...
T = TypeVar("T", bound="Corev1VolumeSource")


@_attrs_define
class Corev1VolumeSource:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        corev_1_volume_source.additional_properties = d
        return corev_1_volume_source
