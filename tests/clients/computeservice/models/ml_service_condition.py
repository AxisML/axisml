...
T = TypeVar("T", bound="MLServiceCondition")


@_attrs_define
class MLServiceCondition:
    """
    Attributes:
        status (str): Condition status (True, False, Unknown).
        type_ (str): Condition type (e.g. Available, Progressing).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ml_service_condition.additional_properties = d
        return ml_service_condition
