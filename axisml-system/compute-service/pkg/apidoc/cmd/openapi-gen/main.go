...
//
//	go run ./cmd/openapi-gen -o ../../../docs/apis/compute-service.yaml -embed ../apispec/openapi.gen.yaml
package main
...
import (
	...
	"github.com/axisml/axisml/axisml-system/compute-service/pkg/apidoc"
...
func main() {
	out := flag.String("o", "../../../docs/apis/compute-service.yaml", "output path")
