...
完整系统级不变量见 [high_level_design.md §2.2](../../docs/system_design/high_level_design.md#22-关键不变量)。schema 见 [database.md](../../docs/system_design/database.md)，部署见 [deployment.md](../../docs/system_design/deployment.md)，基础设施依赖见 [infra/overview.md](../../axisml-infra/docs/overview.md)。
