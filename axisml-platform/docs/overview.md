...
产品需求见 [PRD](../../docs/product_design/prd.md)，页面设计以 [交互原型 prototype/](../../docs/product_design/prototype) 为准（[wireframe](../../docs/product_design/wireframe.md) 仅作补充），系统全景见 [high_level_design.md](../../docs/system_design/high_level_design.md)。
