...
type ResourcePool struct {
	...
	Tolerations     []Toleration   `json:"tolerations,omitempty" desc:"Pod tolerations applied to workloads scheduled onto the pool."`
...
type ResourcePoolPatchRequest struct {
	...
	Tolerations  []Toleration `json:"tolerations,omitempty" desc:"Replacement toleration set."`
...
type ResourceUnit struct {
	...
	Tolerations  []Toleration `json:"tolerations,omitempty" desc:"Additional pod tolerations for this unit."`
	Annotations  StringMap    `json:"annotations,omitempty" desc:"User-defined annotations."`
}
