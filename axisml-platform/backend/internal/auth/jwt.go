...
// restarts and JWKS stays consistent across replicas.
func NewSigner(pemKey, kid string, ttl time.Duration) (*Signer, error) {
	...
	return &Signer{priv: priv, kid: kid, ttl: ttl}, nil
}
